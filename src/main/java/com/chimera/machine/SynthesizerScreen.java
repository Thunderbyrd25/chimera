...
public class SynthesizerScreen extends AbstractContainerScreen<SynthesizerMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ChimeraMod.MODID, "textures/gui/container/synthesizer.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        MachineScreenUtil.drawSlotBox(guiGraphics, leftPos + SynthesizerMenu.FUEL_X, topPos + SynthesizerMenu.FUEL_Y);
